 ...
 * @returns Boolean
 */
export const isShortDescNode = (value?: ShortDescNode): value is ShortDescNode =>
  typeof value === 'object' && areFieldsValid(ShortDescFields, value as unknown as Record<string, BasicValue>,  isValidShortDescField);
