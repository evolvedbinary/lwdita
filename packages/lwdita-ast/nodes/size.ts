 ...
 * @returns Boolean
 */
export const isSizeNode = (value?: SizeNode): value is SizeNode =>
  typeof value === 'object' && areFieldsValid(SizeFields, value as unknown as Record<string, BasicValue>,  isValidSizeField);
