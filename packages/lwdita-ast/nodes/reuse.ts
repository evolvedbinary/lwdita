 ...
 * @returns Boolean
 */
export const isReuseNode = (value?: ReuseNode): value is ReuseNode =>
  typeof value === 'object' && areFieldsValid(ReuseFields, value as unknown as Record<string, BasicValue>,  isValidReuseField);
