 ...
 * @returns Boolean
 */
export const isMediaMutedNode = (value?: MediaMutedNode): value is MediaMutedNode =>
  typeof value === 'object' && areFieldsValid(MediaMutedFields, value as unknown as Record<string, BasicValue>,  isValidMediaMutedField);
