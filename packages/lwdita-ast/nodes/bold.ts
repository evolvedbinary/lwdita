 ...
 * @returns Boolean
 */
export const isBoldNode = (value?: BoldNode): value is BoldNode =>
  typeof value === 'object' && areFieldsValid(BoldFields, value as unknown as Record<string, BasicValue>,  isValidBoldField);
