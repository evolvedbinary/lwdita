 ...
 * @returns Boolean
 */
export const isAltNode = (value?: AltNode): value is AltNode =>
  typeof value === 'object' && areFieldsValid(AltFields, value as unknown as Record<string, BasicValue>,  isValidAltField);
