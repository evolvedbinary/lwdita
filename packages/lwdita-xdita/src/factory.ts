...
import { EmNodeAttributes } from "@evolvedbinary/lwdita-ast";
import { ExampleNodeAttributes } from "@evolvedbinary/lwdita-ast";
import { FallbackNodeAttributes } from "@evolvedbinary/lwdita-ast";
...
import { KeydefNodeAttributes } from "@evolvedbinary/lwdita-ast";
...
import { NavtitleNodeAttributes } from "@evolvedbinary/lwdita-ast";
import { NoteNodeAttributes } from "@evolvedbinary/lwdita-ast";
import { OlNodeAttributes } from "@evolvedbinary/lwdita-ast";
import { OthermetaNodeAttributes } from "@evolvedbinary/lwdita-ast";
...
import { StrongNodeAttributes } from "@evolvedbinary/lwdita-ast";
...
import { TopicmetaNodeAttributes } from "@evolvedbinary/lwdita-ast";
import { TopicrefNodeAttributes } from "@evolvedbinary/lwdita-ast";
import { TtNodeAttributes } from "@evolvedbinary/lwdita-ast";
...
export function createNode(node: XMLNode<'div'>): DivNodeAttributes;
...
export function createNode(node: XMLNode<'em'>): EmNodeAttributes;
export function createNode(node: XMLNode<'example'>): ExampleNodeAttributes;
export function createNode(node: XMLNode<'fallback'>): FallbackNodeAttributes;
...
export function createNode(node: XMLNode<'keydef'>): KeydefNodeAttributes;
export function createNode(node: XMLNode<'keytext'>): KeytextNodeAttributes;
export function createNode(node: XMLNode<'li'>): LiNodeAttributes;
export function createNode(node: XMLNode<'map'>): MapNodeAttributes;
...
export function createNode(node: XMLNode<'metadata'>): MetadataNodeAttributes;
export function createNode(node: XMLNode<'navtitle'>): NavtitleNodeAttributes;
...
export function createNode(node: XMLNode<'othermeta'>): OthermetaNodeAttributes;
...
export function createNode(node: XMLNode<'strong'>): StrongNodeAttributes;
...
export function createNode(node: XMLNode<'topicmeta'>): TopicmetaNodeAttributes;
export function createNode(node: XMLNode<'topicref'>): TopicrefNodeAttributes;
export function createNode(node: XMLNode<'tt'>): TtNodeAttributes;
