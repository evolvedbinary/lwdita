...
/**
 * Define all allowed `media-controls` fields:
...
/**
 * Check if the given fields of the `media-controls` node are valid
 *
 ...
 * @param isValidMediaControlsField - A boolean value, if the field is valid or not
