...
/**
 * Check if the given fields of the `dt` node are valid and matches this list:
 * @See {@link DtFields}
 * 
...
/**
 * Construct an `dt` node with all available attributes
 * 
 ...
 * @param isValidDtField - A boolean value, if the field is valid or not
 * @param DtFields - An array containing all valid field names See {@link DtFields}
